...
import application.server.configuration.types.TimeConfigType;

import java.util.Objects;

/**
 * The TimerConfig class is a record class that holds the configuration for the timers in the application.
